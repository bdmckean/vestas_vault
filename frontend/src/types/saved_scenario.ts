...
export interface SavedScenario {
  ...
  spouse_ss_start_age_years: number | null;
  ...
  use_bucket_strategy: boolean;
  bucket_strategy_type: 'A' | 'B';
  bucket_1_years: number;
  bucket_2_years: number;
...
export interface ScenarioYearProjection {
  ...
  primary_ss_income: string;
  spouse_ss_income: string;
  other_income: string;
  total_income: string;
  ...
  pretax_withdrawal: string;
  taxable_withdrawal: string;
  cash_withdrawal: string;
  roth_withdrawal: string;
...
export interface ScenarioProjectionResult {
  ...
  initial_pretax?: string;
  initial_roth?: string;
  initial_taxable?: string;
  initial_cash?: string;
  final_pretax?: string;
  final_roth?: string;
  final_taxable?: string;
  final_cash?: string;
...
export const SCENARIO_ASSET_CLASS_INFO: Record<
  keyof AssetAllocation,
  { label: string; ticker: string; expectedReturn: number }
> = {
